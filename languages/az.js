...
overview: require("../locales.config.js")["az"],
    ...
    footer: {
      ...
      developedWith: 'clqu & swoth tərəfindən ❤ ilə hazırlanıb, Award komandası tərəfindən redaktə edilib. ',
      allServices: 'Bütün xidmətlər aktivdir!',
      someServices: 'bəzi xidmətlər qeyri-aktivdir!'
    },
    index: {
      title: 'Discord-da ən yaxşı lotereya botu! ',
      description: 'Award ilə siz sosial media hesablarınızı təkmilləşdirə və qabaqcıl lotereyalar yaradaraq üzvi artımlar əldə edə bilərsiniz!',
      buttons: {
        dashboard: 'idarəetmə paneli',
        support: 'dəstək serveri',
      ...
      features: {
        ...
        items: [
          { icon: 'fal fa-star', title: 'Asanlıqla şərti lotereyalar yaradın', description: 'Xəyallarınızdakı üzvlərə qısa zamanda sahib ola bilərsiniz.Youtube,twitch,twitter kimi sosial media hesablarınızı Award vasitəsilə izləyə və şərti tirajlar açaraq üzvi artım əldə edə bilərsiniz.Ətraflı məlumat üçün niyə lotereya açmağa cəhd etməyəsiniz?' },
      ...
      advanced: [
        { placement: "left", imageUrl: 'https://i.imgur.com/YY3hwTn.png', title: 'Hesablarınızı böyüdün', description: 'Award ilə hesablarınızı üzvi şəkildə inkişaf etdirin və böyüdün.' },
        { placement: "right", imageUrl: 'https://i.imgur.com/5X0ha3F.png', title: 'Püşkatmalarınızı kilidləyin', description: 'Award\kilid sistemi ilə lotereyalarınızı özəl olaraq şifrələyin .' },
    ...
    team: {
      title: 'Bizim komanda',
      description: 'İşçi və Award\a töhfə verən<br> Tapılan hər kəsi tapa bilərsiniz. Komandamıza çox təşəkkür edirik. <3 ',
      linkcordLang: 'az',
    ...
    user: {
      ...
      connections: {
        title: 'Bağlantılar',
        description: 'Award/ ilə əlaqələndirdiyiniz sosial media hesablarını buradan idarə edə bilərsiniz.',
        button: {
    ...
    dashboard: {
      ...
      auditLog: {
        title: 'audit jurnalı',
        description: 'Bu serverdə Award\'da edilən dəyişikliklərin audit jurnalına burada baxmaq olar.',
        table: {
          user: 'İstifadəçi',
          date: 'Tarix',
          action: 'Proses',
