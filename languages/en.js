module.exports = {
    ...
    footer: {
        ...
        developedWith: 'Developed with ❤️ by clqu & Swôth & Edited by Award Team.',
    ...
    index: {
        ...
        features: {
            ...
            items: [
                 ...
                 { icon: 'fal fa-star', title: 'Self Feel Special', description: 'By purchasing Boost, you can giveaway more than 20 simultaneous Award on your server, however, you can repeat and embed 20 times on a giveaway. You can make it safe by adding a password to your giveaways.' }
            ]
        },
        advanced: [
            { placement: "left", imageUrl: 'https://i.imgur.com/twQBhV3.png', title: 'Grow your accounts', description: 'Develop and grow your accounts organically with Award.'},
            { placement: "right", imageUrl: 'https://i.imgur.com/aQFJbiI.png', title: 'Lock your giveaways', description: "Privately encrypt your giveaways with Award's lock system." },
