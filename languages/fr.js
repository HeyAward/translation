module.exports = {
  ...
  footer: {
    ...
    developedWith: "Développé avec ❤️ par clqu & Swôth & édité par Award Équipe.",
  ...
  advanced: [
      { placement: "left", imageUrl: 'https://i.imgur.com/twQBhV3.png', title: 'Développez vos comptes', description: 'Avec Award, vous pouvez développer vos comptes de manière organique.'},
      { placement: "right", imageUrl: 'https://i.imgur.com/aQFJbiI.png', title: 'Verrouillez vos tirages au sort', description: 'Chiffrez vos tirages au sort en privé avec le système de verrouillage de Award.' },
