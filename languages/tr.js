module.exports = {
  ...
  footer: {
    ...
    developedWith: 'clqu & Swôth tarafından ❤️ ile geliştirildi & Award Ekibi tarafından düzenlendi',
  ...
  index: {
    ...
    advanced: [
      { placement: "left", imageUrl: 'https://i.imgur.com/twQBhV3.png', title: 'Hesaplarınızı büyütün', description: 'Award ile hesaplarınızı organik olarak geliştirin ve büyütün.' },
      { placement: "right", imageUrl: 'https://i.imgur.com/aQFJbiI.png', title: 'Çekilişlerinizi kilitleyin', description: 'Award\'in kilit sistemiyle çekilişlerinizi özel olarak şifreleyin.' },
